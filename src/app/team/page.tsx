        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-10 pt-8 border-t border-white/10 flex flex-col items-center w-full max-w-md mx-auto">
              ...
              <a href="https://www.linkedin.com/in/manoj-kumar-keshri-078822419" target="_blank" rel="noreferrer" className="mt-5 w-[38px] h-[38px] rounded-full bg-white/10 flex items-center justify-center hover:bg-[#c29b62] transition-colors group border border-white/5">
