        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-10 pt-8 border-t border-white/10 flex flex-col items-center w-full max-w-md mx-auto">
              ...
              <h3 className="text-[19px] sm:text-2xl font-bold text-white tracking-wide whitespace-nowrap">Manoj Kumar Keshri<span className="text-[#c29b62] text-base sm:text-lg font-medium">, FCA</span></h3>
              ...
              <div className="mt-5 flex items-center justify-center gap-4">
                <a href="https://www.linkedin.com/in/manoj-kumar-keshri-078822419" target="_blank" rel="noreferrer" className="w-[38px] h-[38px] rounded-full bg-white/10 flex items-center justify-center hover:bg-[#c29b62] transition-colors group border border-white/5">
                ...
                <a href="tel:+917045348228" className="flex items-center gap-2.5 group hover:text-[#c29b62] transition-colors">
                  <div className="w-[38px] h-[38px] rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#c29b62] transition-colors border border-white/5">
                    <svg className="w-[18px] h-[18px] text-gray-300 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <span className="text-gray-300 group-hover:text-white font-medium text-[15px] tracking-wide whitespace-nowrap">+91 70453 48228</span>
                </a>
              </div>
            </div>
          </div>
